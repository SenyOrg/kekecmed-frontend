              ...
              <li>
                <a href="javascript:void(0)">
                  ...
                  <div className="progress progress-xxs">
                    <div className="progress-bar progress-bar-danger" style={{widht: '70%'}}></div>
                  </div>
                </a>
              </li>
              <li>
                <a href="javascript:void(0)">
                  ...
                  <div className="progress progress-xxs">
                    <div className="progress-bar progress-bar-success" style={{widht: '70%'}}></div>
                  </div>
                </a>
              </li>
              <li>
                <a href="javascript:void(0)">
                  ...
                  <div className="progress progress-xxs">
                    <div className="progress-bar progress-bar-warning" style={{widht: '70%'}}></div>
                  </div>
                </a>
              </li>
              <li>
                <a href="javascript:void(0)">
                  ...
                  <div className="progress progress-xxs">
                    <div className="progress-bar progress-bar-primary" style={{widht: '70%'}}></div>
                  </div>
                </a>
              </li>
            </ul>
