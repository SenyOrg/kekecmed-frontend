...
const selectTable = () => createSelector(
  selectView(),
  (vieState) => vieState.get('table')
);

const selectTableFilterText = () => createSelector(
  selectTable(),
  (viewState) => viewState.get('filter')
);

const selectTableSelection = () => createSelector(
  selectTable(),
  (viewState) => viewState.getIn('selection')
);

const selectTableFilterModel = () => createSelector(
  selectTable(),
  (viewState) => viewState.getIn('filterModel')
)
...
export {
  ...
  selectErrorState,
  selectTable,
  selectTableFilterText,
  selectTableSelection,
  selectTableFilterModel
};
